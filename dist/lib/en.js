...
var translations = {
    ...
    "auth.verifyEmailSuccess": "Your recovery email has been verified successfully.",
    "auth.verifyEmailFailure": "Email verification failed, invalid token.",
    "auth.verifyInvitationFailure": "Invalid invitation code.",
    "auth.signup.failure": "Oops, something went wrong on our end. Hold on tight while we patch things up. Please send us a note via support.onmail.com if this persists.",
    "auth.recoveryEmailUnverified": "Please verify your recovery email address, we sent a verification email to <0>{{ email }}</0>. <1>Resend activation.</1>",
    ...
    "signup.form.email.length": "Sorry, your username must be between {{ minChars }} and 64 characters.",
    "signup.form.password.length": "Sorry, your password must be between 6 and 128 characters.",
    "signup.form.email.invalid": "Sorry, your username contains invalid characters.",
    ...
    "signup.form.confirmPassword.placeholder": "Please enter your password again.",
    "signup.form.confirmPassword.match": "Passwords must match.",
    "signup.form.password.invalidCharacters": "Your password contains invalid characters.",
    "signup.form.recoveryEmail.header": "Add an account recovery email.",
    "signup.form.recoveryEmail.description1": "Your recovery method is used to reach you in case you accidentally get locked out.",
    "signup.form.recoveryEmail.description2": "Please enter a recovery email address.",
    ...
    "signup.form.firstName.length": "Sorry, but your first name cannot be longer than 255 characters.",
    "signup.form.lastName.label": "Last Name",
    "signup.form.lastName.length": "Sorry, but your last name cannot be longer than 255 characters.",
    ...
    "signup.invitationOnly.form.email.invalid": "Please enter a valid email address.",
    "signup.invitationOnly.form.email.required": "Please enter the email address you used for beta signup.",
    "signup.invitationOnly.form.code": "Invite Code",
    "signup.invitationOnly.form.code.required": "Please enter a valid invite code.",
    "signup.invitationOnly.form.submit": "Let's Get Started",
    "signup.invitationOnly.header": "Enter invitation code to continue.",
    "signup.invitationOnly.title": "OnMail is currently only available through invitation",
    "signup.invitationOnly.subtitle": "Sign up now to experience the future of email.",
    "signup.planRestrictions.toolTip": "{{ email }} is a premium email address and is only available with Professional or Business plans. All other plans have access to account names with 8 or more characters.",
    "signup.planRestrictions": "Email addresses with fewer than 8 characters are only available on our <0>Professional</0> or <0>Business</0> plans starting at $9.99/month.",
    "signup.hobbyPlanRestrictions.toolTip": "Personal plans are currently invite-only.",
    "signup.hobbyNotAllowed.toolTip": "Please contact us via support.onmail.com in order to complete this process.",
    ...
    "signup.subAccount.confirm.message": "Creating this user will incur an additional charge of {{ price }} per {{ interval }}.",
    ...
    "resetPassword.success": "Password changed successfully, try logging in again.",
    "resetPassword.failure": "There was a problem with resetting your password, please resend the forgot password email.",
    // Create Password
    ...
    "navigation.upgradeToFreelance": "Get a free custom domain with a Freelance plan. <0>Upgrade to Freelance</0>",
    "navigation.getYourFreeDomain": "Did you know your Freelance plan comes with a free domain? <0>Get your free domain</0>",
    // Settings
    ...
    "settings.general.language.description": "Choose your language to make OnMail your own. We support 25 different languages",
    "settings.general.theme.description": "",
    "settings.general.undoDuration.label": "Undo Send",
    "settings.general.undoDuration.description": "Accidentally send a message you wish you hadn't. Give yourself way out. Choose a cancellation period to show undo send option",
    "settings.general.smartReply.label": "Smart Reply",
    "settings.general.smartReply.description": "Make it quick and easy, respond to messages quickly with responses based on message context and frequent replies",
    "settings.general.followUpNudge.label": "Follow Up Nudge",
    "settings.general.followUpNudge.description": "Email's you have sent and may need to follow up on. It can be useful when you haven't heard back from someone about a question you had asked",
    "settings.general.replyToNudge.label": "Reply To Nudge",
    "settings.general.replyToNudge.description": "Highlight email's you may have forgotten to respond to",
    "settings.general.messagePreviewText.label": "Message Preview Text",
    "settings.general.messagePreviewText.description": "Customize your email list by hiding the message preview text from the mail feed",
    "settings.general.attachmentPreview.label": "Attachment Preview",
    "settings.general.attachmentPreview.description": "View attachment images in your inbox, quick action to download and view the image without having to open the email",
    "settings.general.priceAlertTracking.label": "Price Alert Tracking",
    "settings.general.priceAlertTracking.description": "OnMail will automatically track purchases eligible for refunds within the price alert window",
    "settings.general.smartFolders.label": "Smart Folders",
    "settings.general.smartFolders.description": "Automatically categorize Travel, Packages, Events and Receipts into smart folders in the main menu",
    "settings.general.forwardingAccounts.label": "Forwarding Accounts",
    "settings.general.forwardingAccounts.description": "You can forward all of your OnMail messages to another email address.",
    "settings.general.forwardingAccounts.newEmailButton": "Add a new address",
    "settings.general.forwardingAccounts.newEmailModal.title": "Add Forwarding Address",
    "settings.general.forwardingAccounts.newEmailModal.description": "Enter an email address you have access to",
    "settings.general.forwardingAccounts.duplicated": "You already have the forwarding address {{ email }}.",
    "settings.general.forwardingAccounts.self": "You cannot specify your own email address.",
    "settings.general.forwardingAccounts.verificationSent.title": "Verification Sent",
    "settings.general.forwardingAccounts.verificationSent.description": "A confirmation link has been sent to <1>{{ email }}</1> to verify permission",
    "settings.general.forwardingAccounts.error.emailAddress": "Invalid email address",
    "settings.general.forwardingAccounts.verification.success.title": "Your email has been successfully verified.",
    "settings.general.forwardingAccounts.verification.success.subtitle": "{{ senderEmail }} can now forward emails to {{ receiverEmail }}",
    "settings.general.forwardingAccounts.verification.success.button": "Back To OnMail",
    "settings.general.forwardingAccounts.verification.failure.title": "Failed to verify your email.",
    "settings.general.forwardingAccounts.verification.failure.subtitle": "Please resend the verify email",
    "settings.general.recoveryEmail.duplicated": "You already set it as the recovery email, please use a different address.",
    ...
    "settings.notifications.webNotification.description": "Get notifications delivered through the web browser and never miss an email",
    "settings.notifications.notificationFilter.label": "Notification Filters",
    "settings.notifications.notificationFilter.description": "Fine tune your notifications to help focus on what matters",
    // Storage
    ...
    "settings.storage.alert.full": "You're out of storage, you won't be able to store new files and may not be able to send and receive emails.",
    ...
    "settings.signature.signature.description": "Create a custom email signature to leave the best first impression.",
    "settings.signature.error.exceedMaxLength": "Signature length can't exceed {{ maxLength }}.",
    // Profile
    "settings.account.avatar.label": "Photo",
    "settings.account.avatar.description": "Choose a photo to display alongside your sent mail.",
    ...
    "settings.recovery.email.description": "Just in case you get locked out of your account, add in a recovery email so we can help you get back in.",
    "settings.recovery.email.form": "Enter a recovery email",
    "settings.recovery.email.form.label": "recovery email address",
    "settings.recovery.email.verificationSent": "A verification email has been sent to your address. Follow the instructions in your email to verify this address. If you do not see it please try again.",
    ...
    "settings.recovery.password.description": "Change your email account password.",
    "settings.recovery.password.button": "Change",
    "settings.recovery.password.success": "Password updated successfully.",
    "settings.recovery.password.failure": "There was a problem with resetting your password, please try again later.",
    "settings.recovery.password.form.currentPassword.label": "Current Password",
    // SMTP Proxy
    "settings.smtpProxy.setDefault": "Choose",
    "settings.smtpProxy.setDefault.success": "Success! OnMail will send your emails as {{ email }}.",
    ...
    "settings.smtpProxy.providers.subtitle": "Select the email provider your'd like to connect to OnMail",
    "settings.smtpProxy.providers.google.success": "Success! Gmail account connected.",
    "settings.smtpProxy.providers.google.error": "Failed to connect Gmail account.",
    // Attachment Links
    "settings.attachmentLinks": "Attachment Links",
    "settings.attachmentLinks.empty.title": "Send any attachments without worrying about file size",
    "settings.attachmentLinks.empty.subtitle": "Files over 25MB sent to OnMail users will be sent as attachments, with those sent to non-OnMail users sent as links. All of these large attachments can be managed here.",
    "settings.attachmentLinks.delete": "Once you delete this, recipients with this link will no longer be able to download these attachments.",
    "settings.attachmentLinks.passwordProtection": "Password Protection",
    "settings.attachmentLinks.passwordProtection.message": "Only people with the password will be able to view and download these attachments.",
    // Split Inbox
    "settings.splitInbox.empty.title": "Structure your inbox the way that works for you",
    "settings.splitInbox.empty.subtitle": "Create customizable inboxes for different types of messages so you can stay focused on what you want, when you want.",
    "settings.splitInbox.name.title": "What would you like to call your new split inbox?",
    ...
    "settings.splitInbox.error.duplicate": "This condition is already in use. Try using advanced options to create this split inbox.",
    "settings.splitInbox.success.update": "{{ name }} updated.",
    // Label
    "settings.label.empty.title": "You haven't labeled anything yet",
    "settings.label.empty.subtitle": "Labels help you categorize your messages so you can find what you need in a snap.",
    ...
    "settings.label.error.reserved": '"{{ value }}" is a reserved system label. Please try another name.',
    "settings.label.error.duplicated": "This name already exists. Please try another name.",
    "settings.label.error.invalid": 'The "{{ value }}" is not allowed. Please try another name.',
    ...
    "settings.filter.empty.subtitle": "Manage your messages hands-free. Set rules to automatically send certain emails to a label, mark as read, and more.",
    "settings.filter.normal.text": "All Messages",
    "settings.filter.advanced.text": "Advanced Filter",
    "settings.filter.advanced.note": "Add multiple terms by using common search operators.",
    ...
    "settings.filter.action.forward.note": "Note: Existing threads will not be forwarded",
    "settings.filter.action.spam.label": "Never Mark as Spam",
    "settings.filter.action.spam.note": "Note: Filter will not be applied to existing threads in Spam and Trash",
    "settings.filter.action.forward.emptyList": "No available forwarding addresses. <1>Add forwarding address</1>",
    ...
    "settings.vacationResponder.description": "Set up an automated message when you are away. Select an optional end date or manually disable this message upon your return.",
    "settings.vacationResponder.start": "Start Date",
    "settings.vacationResponder.end": "End Date",
    // Contacts
    "settings.contacts.empty.title": "There are no emails between you and this sender.",
    "settings.contacts.empty.subtitle": "Send some messages and they'll show up here.",
    "settings.contacts.block.empty.title": "You don't have any blocked contacts yet",
    "settings.contacts.block.empty.subtitle": "If you block senders, you can edit or unblock them here.",
    "contacts.suggestedBlock.title": "Suggested Inbox Clean Up",
    "contacts.suggestedBlock.description": "You rarely open emails from {{ name }}. Would you like to block these emails?",
    "contacts.approved.empty.title": "You don't have any contacts yet",
    "contacts.approved.empty.subtitle": "Send or receive emails and your contacts will show up here.",
    "contacts.blocked.empty.title": "You don't have any blocked contacts yet",
    "contacts.blocked.empty.subtitle": "If you block senders, you can edit or unblock them here.",
    "contacts.pending.empty.title": "You have no pending contacts to accept",
    "contacts.pending.empty.subtitle": "Once you receive emails from new contacts, they will appear here.",
    ...
    "settings.domain.disconnect.description": "This action will permanently delete all accounts associated with {{ domain }}.",
    "settings.domain.disconnect.confirm.title": "Are you sure?",
    "settings.domain.disconnect.confirm.description": "<0>This action will permanently delete all accounts associated with {{ domain }}. You will no longer be able to create these accounts using OnMail.</0><0>This should only be done if you are absolutely sure.</0>",
    "settings.domain.disconnect.confirm.label": "Type in <0>{{ domain }}</0> to confirm.",
    "settings.domain.disconnect.confirm.placeholder": "Enter Domain to Disconnect",
    // Custom Domain
    "settings.customDomain.subAccountDetail.passwordReset.title": "password reset",
    "settings.customDomain.subAccountDetail.passwordReset.description": "Passwords can be reset for users in case they got locked out of their account.",
    "settings.customDomain.subAccountDetail.passwordReset.button": "Generate password reset link",
    ...
    "settings.customDomain.subAccountDetail.dangerZone.description": "This action is irreversible, and the user will lose access to their account. This account name cannot be used again.",
    "settings.customDomain.subAccountDetail.dangerZone.button": "Delete this account",
    "settings.customDomain.subAccountDetail.deletionConfirm.title": "Are you sure?",
    "settings.customDomain.subAccountDetail.deletionConfirm.description": "Type in the email address below to confirm deletion. This will permanently delete this account.",
    "settings.customDomain.subAccountDetail.deletionConfirm.placeholder": "Enter Email Address",
    "settings.customDomain.subAccountDetail.deletionConfirm.failed": "Failed to delete this account. Please try again later, or contact us via support.onmail.com.",
    ...
    "settings.customDomain.newAccount.email.invalid": "Email address should not contain invalid characters.",
    "settings.customDomain.newAccount.invitationLink": "invitation link",
    "settings.customDomain.convertEmail.form.title": "Create a custom domain email address",
    "settings.customDomain.convertEmail.form.description": "You may login to OnMail with either {{ email }} or your new custom domain email address.",
    "settings.customDomain.convertEmail.form.warning": "This operation is irreversible. Once the email address is created, you cannot change it.",
    ...
    "settings.customDomain.error.length": "Email address must be at least {{ minChars }} characters.",
    "settings.customDomain.error.invalidEmail": "Invalid email address.",
    "settings.customDomain.error.duplicated": "This email already exists, please choose a different one.",
    ...
    "settings.customDomain.records.description": "OnMail is flexible, adjust your DNS records to add new services to your domain.",
    ...
    "settings.customDomain.records.view.featureError.landingPage": "Removing this record will remove your branded landing page.",
    "settings.customDomain.records.view.featureError.restricted": "This record is used by OnMail for custom domain functionalities.",
    "settings.customDomain.records.add.error": "An error occurred when adding this custom domain record.",
    // NS
    ...
    "settings.customDomain.records.domainManagedExternally": "DNS managed externally",
    "settings.customDomain.records.domainManagedExternally.p": "Your DNS is managed by a third-party provider.",
    "settings.customDomain.records.domainManagedExternally.image": "https://assets.easilydo.com/onmail/custom-domain-dns-managed-externally.png",
    "settings.customDomain.error.pendingDowngrade": "Your account has a pending downgrade, we cannot perform this action at this time. Please contact us via support.onmail.com if you have any questions.",
    "settings.customDomain.error.pendingCancellation": "Your account has a pending cancellation, we cannot perform this action at this time. Please contact us via support.onmail.com if you have any questions.",
    "settings.customDomain.error.insufficientFunds": "Your payment method has insufficient funds. Please update your payment method in Settings.",
    "settings.customDomain.verify.domainManagedByOnMail": "Domain Managed by OnMail",
    "settings.customDomain.verify.domainManagedByOnMail.image": "https://assets.easilydo.com/onmail/custom-domain-dns-managed-by-onmail.png",
    ...
    "settings.customDomain.setup.customBranding.header": "Custom Branding Records",
    ...
    "settings.customDomain.setup.FAQ": "https://support.onmail.com/hc/en-us/articles/360051750012-Custom-Domain-Guide",
    ...
    "settings.customDomain.setup.disconnect.description": "This action will permanently delete all accounts associated with {{ domain }}.",
    "settings.customDomain.setup.disconnect.button": "Disconnect Domain",
    "settings.customDomain.setup.copied": "Record value has been copied to your clipboard.",
    ...
    "settings.securityPrivacy.optIn.description": "Data makes our technology work better for you. You can opt-out of data sharing at any time.",
    "settings.securityPrivacy.delete.title": "Delete my account",
    "settings.securityPrivacy.delete.description": "At any time, you can discontinue use of this service and delete the information in this account and on our servers.",
    "settings.securityPrivacy.dataExport.title": "Export my data",
    "settings.securityPrivacy.dataExport.description": "Easily access all data associated with your OnMail account in a downloadable zip file.",
    "dataExport.beforeRequest.image": "https://assets.easilydo.com/onmail/email-assets/security-export-data.jpg",
    "dataExport.beforeRequest.title": "What’s included in my data export?",
    "dataExport.beforeRequest.description": "Your OnMail data export contains all information saved to OnMail including emails, attachments, contacts, and personal data. The export link will be delivered to",
    "dataExport.requested.image": "https://assets.easilydo.com/onmail/data-export.png",
    "dataExport.requested.title": "Data export requested",
    "dataExport.requested.description": "This process can take up to 24-48 hours to complete. When finished, you’ll receive an email with an export download link at",
    "dataExport.downloadSuccess.title": "Your export is ready",
    "dataExport.downloadSuccess.image": "https://assets.easilydo.com/onmail/email-assets/security-export-data.jpg",
    "dataExport.downloadSuccess.description": "Click the links below to download your data.",
    "dataExport.downloadSuccess.warning": "Warning: For your security, we recommend you do not share your export links that may contain your personal or sensitive information.",
    "dataExport.downloadFailure.title": "This link is not associated with this OnMail account",
    "dataExport.downloadFailure.image": "https://assets.easilydo.com/onmail/email-assets/security-export-data.jpg",
    ...
    "dataExport.failure.toolTip": "There was an issue with data export, please contact us via support.edison.tech for more information.",
    // Approve Sender
    "approveSender.senderCard.text": "Contact Request",
    "approveSender.approve.error": "Failed to approve. Please try again.",
    "approveSender.block.prompt": "All messages from this sender will be sent to the Trash.",
    "approveSender.block.error": "Failed to block. Please try again.",
    "approveSender.thread.error": "Threads from this sender are not available to review.",
    // Compose
    "compose.beforeUnload": "Changes you made may not be saved.",
    "compose.send.error.exceedMaxSize": "Your message could not be saved because it exceeds the maximum size of {{ maxSize }}.",
    ...
    "compose.send.error.exceedMaxRecipientCount": "Total recipients cannot exceed {{ maxCount }}.",
    "compose.send.confirm.emptyBodyOrSubject": "Send this message without a subject or text in the body?",
    "compose.send.confirm.errorAttachment": "Note: There were errors attaching your file(s). Send this message without these attachments?",
    "compose.send.confirm.uploadingAttachment": "Message will be sent after attachments have finished uploading.",
    ...
    "compose.upload.error.emptySize": "{{ fileName }} is 0 bytes, so it will not be attached. Please re-attach your files again without {{ fileName }}.",
    "compose.upload.error.wrongType": "Invalid file type",
    "compose.upload.error.maxSize": "The total size of your attachments cannot be larger than 25MB.",
    ...
    "compose.upload.error.exceedTotalSize": "Total usage cannot exceed {{ total }}.",
    "compose.attachmentBox.subject": "{{ count }} Upload Remaining",
    "compose.attachmentBox.subject_plural": "{{ count }} Uploads Remaining",
    "compose.attachmentBox.tip": "Pending messages will be sent after upload is completed.",
    "compose.attachmentBox.tip2": "Your attachments are over 25MB and will be sent as a link.",
    "compose.attachmentBox.uploadComplete": "Upload Completed",
    "compose.attachmentBox.uploadError": "Error uploading attachments",
    "compose.attachmentBox.uploadErrorExpand": "There was an issue with your upload.",
    "compose.attachmentBox.passwordProtection": "Enable password protection",
    "compose.attachmentBox.beforeUnload": "If you leave this page the upload will be canceled and your message will not be sent.",
    "compose.toast.uploading": "Message will send after attachments are done uploading.",
    ...
    "compose.toast.networkError": "Message could not be sent. Check your network and try again.",
    "compose.toast.attachFailure": "There was an error attaching your image.",
    "compose.dropFile": "Drop files here.",
    // Search
    "search.moreIn.tips": "Some messages in Trash or Spam match your search. <1>View Messages</1>.",
    ...
    "search.recommendations.noResults.message": "We couldn't find anything matching your search term.",
    // Search Operators
    "search.operators.or.desc": "Results match multiple terms.",
    "search.operators.and.desc": "Results match all terms.",
    "search.operators.not.desc": "Results do not match the specified search term.",
    // Search result count
    ...
    "feedView.description": "<0>Give your newsletters and promotions a face left.</0><0>Browse them in the new feed and mark them all as done in one click.</0>",
    // Thread list actions
    ...
    "thread.error.deletedConversation": "The requested conversation has been deleted and is no longer available.",
    "threadList.selectAllThreads.selectAll": "Select All",
    "threadList.selectAllThreads.selectUniverse": "Select all {{numUniverse}} threads in {{label}}?",
    "threadList.selectAllThreads.numSelected": "You've selected {{numSelected}} thread.",
    "threadList.selectAllThreads.numSelected_plural": "You've selected {{numSelected}} threads.",
    "threadList.selectAllThreads.numUniverse": "{{numUniverse}} thread in {{label}} is selected.",
    "threadList.selectAllThreads.numUniverse_plural": "All {{numUniverse}} threads in {{label}} are selected.",
    ...
    // Large Attachment
    "largeAttachment.error.exceedMaxFileSize": "File size can't exceed {{ maxSize }}.",
    "largeAttachment.error.exceedMaxFileNumber": "Total file number can't exceed {{ maxNumber }}.",
    "largeAttachment.error.exceedMaxUsage": "File usage can't exceed {{ maxUsage }} in composer.",
    "largeAttachment.error.exceedMaxTotalUsage": "Total file usage can't exceed {{ maxTotalUsage }}.",
    // Preview
    ...
    // OnBoarding
    "onBoarding.backgroundImage": "https://assets.easilydo.com/onmail/onmail-landing-bg.jpg",
    ...
    "onBoarding.welcome.1.subtitle.1": "Simply accept or block email requests with one click.",
    "onBoarding.welcome.2.title": "Quick Actions",
    "onBoarding.welcome.2.subtitle.0": "Take your time back.",
    "onBoarding.welcome.2.subtitle.1": "Say goodbye to decision fatigue, simplified actions are up front.",
    "onBoarding.welcome.3.title": "Large File Attachments",
    "onBoarding.welcome.3.subtitle.0": "Share bigger ideas.",
    "onBoarding.welcome.3.subtitle.1": "Don’t worry about file size stopping you.",
    "onBoarding.welcome.4.title": "Split Inbox",
    "onBoarding.welcome.4.subtitle.0": "Keep messages organized.",
    "onBoarding.welcome.4.subtitle.1": "Create inbox sections whenever you need to, easily.",
    ...
    "error.application.subtitle[1]": "Try again or contact us if this error persists.",
    "error.application.contact": "Contact Support",
    "error.application.retry": "Try Again",
    //Message
    "message.markedAsSpam": "Marked as Spam",
    "message.readReceiptBlocking.pass": "No tracking pixels were found in this message.",
    "message.readReceiptBlocking.tip": "Email tracking is being blocked for this message.",
    ...
    "message.readReceiptBlocking.title": "We blocked a spy tracker in this email.",
    ...
    "message.suspiciousDetecting.tip": "This message looks suspicious, proceed with caution.",
    "message.suspiciousDetecting.title": "This email looks suspicious",
    "message.suspiciousDetecting.body": "This email did not pass the OnMail security scan. The scan checks email headers for SPF/DKIM/DMARC/ARC records as well as domain verifications. Emails that fail these tests can sometimes be phishing attempts to gather personal information. Please be careful with this message.",
    //Download
    ...
    "download.tip.attachmentNotAvailableDetail": "This file is no longer available. It has been deleted by the owner.",
    ...
    "download.oops": "<0>Oops!</0><1>The page you're looking for is no longer available.</1>",
    "download.password.title": "These files are password-protected",
    "download.password.detail": "Only people with the password will be able to view and download these attachments.",
    // Custom Domains
    ...
    "customDomain.searchDomain.invalidDomain": "The domain you have searched for is invalid.",
    ...
    "customDomain.domainInput.subtitle": "If you already own a domain, enter it here to use with OnMail.",
    "customDomain.dnsSetup.title": "Domain Setup",
    "customDomain.dnsSetup.subtitle": "Add the following text records in order to verify domain ownership.",
    ...
    "customDomain.pendingSetup.takingLonger": "Taking longer? <2>Contact Support</2>",
    ...
    "customDomain.verification.userOwned.failure": "Domain verification failed, please update your DNS records accordingly.",
    "customDomain.entry.title": "Create a custom email address",
    "customDomain.entry.title.tips": "A faster, easier way to build your unique brand",
    "customDomain.entry.getDomain": "Get your own domain",
    "customDomain.entry.connectDomain": "I want to connect my existing custom domain →",
    "customDomain.entry.description": "OnMail makes it simple to acquire your own custom domain and make your own email address. Do it in just one click. Finally, an online identity you can keep forever.",
    "customDomain.entry.step1": "Step 1",
    "customDomain.entry.step1.description": "Choose a domain from countless available options. Standard domain prices are included for free in the OnMail Freelance, Professional, and Business plans.",
    "customDomain.entry.step2": "Step 2",
    "customDomain.entry.step2.description": "Once you have chosen your new domain, create your brand new email address.",
    "customDomain.entry.footer": "That’s it! We take care of the rest. Your new address and custom domain will be ready in a few minutes.",
    "customDomain.signup.invalidInvite": "Invalid/expired invitation link, please obtain a new link from your admin.",
    ...
    "customDomain.connect.userDomain.exists": "This domain name is already taken.",
    "customDomain.connect.userDomain.invalid": "This is an invalid domain name. Please contact us through support.onmail.com if you require assistance.",
    ...
    "premium.features.singleFileSizeLimit": "{{ size }} Attachment File Size Limit",
    "premium.features.customDomain": "Free Custom Domain Included",
    "premium.features.passwordProtectedLargeFileLinks": "Password Protected Large File Links",
    ...
    "premium.payment.info": "Your {{ name }} plan is <0>{{ price }}/{{ interval }}/user</0> and will renew on <0>{{ renewDate }}</0>.",
    ...
    "premium.payment.errorBanner": "There was a problem processing your payment. Please verify your payment information or use a different form of payment.",
    ...
    "premium.upcoming": "Upcoming means that this will be your new plan after your current billing cycle.",
    "premium.notAvailable": "If you would like to switch to this plan, please contact us via support.onmail.com.",
    "premium.billingHistory.title": "Billing History",
    "premium.billingHistory.subtitle": "If you notice any issues with your billing history, please <0>contact us</0>.",
    // Downgrade warnings
    "criticalWarning.title": "Please read carefully before proceeding",
    "criticalWarning.subtitle.domain": "Disconnecting a domain will cause major changes to your account.",
    "criticalWarning.subtitle.premium": "Downgrading will cause major changes to your account.",
    "criticalWarning.items.allowSubAccounts": "All additional email accounts associated with the custom domains will be permanently deleted.",
    "criticalWarning.items.fileStorage": "If your account exceeds the storage limit you will not be able to send or receive messages.",
    "criticalWarning.items.customFileTransferUrl": "Attachments sent using a custom domain link will no longer be accessible.",
    "criticalWarning.items.customDomain": "You will no longer be able to login with your {{ domain }} account, you will need to login using onmail.com after the domain is removed from your account. <0>Learn More</0>",
    "criticalWarning.items.passwordProtectedLargeFileLinks": "You will no longer be able to password protect large attachment links.",
    "criticalWarning.confirmation": "I understand the risks and want to continue.",
    ...
    "paywall.passwordProtectedLargeFileLinks.title": "Attachment link password protection",
    "paywall.passwordProtectedLargeFileLinks.subtitle": "Protect your attachment links with a password",
    ...
    "paywall.contactAdmin.subtitle": "Please contact <0>{{ admin }}</0> in order to change your plan.",
    "paywall.contactAdmin.confirm": "Okay, got it",
    // Contact Detail
    "contactDetail.attachments.title": "Attachments",
    "contactDetail.unblockTip": "This sender has been blocked. All future messages from this sender will be sent to trash.",
    "contactDetail.messages.title": "Messages",
    // Image Assets
    "no-results.png": "https://assets.easilydo.com/onmail/no-results.png",
    "empty-settings-attachment-link.png": "https://assets.easilydo.com/onmail/empty-settings-attachment-link.png",
    "empty-pending-contacts.png": "https://assets.easilydo.com/onmail/empty-pending-contacts.png",
    "empty-settings-contacts-blocked.png": "https://assets.easilydo.com/onmail/empty-settings-contacts-blocked.png",
    "empty-settings-contacts.png": "https://assets.easilydo.com/onmail/empty-settings-contacts.png",
    "empty-settings-filter.png": "https://assets.easilydo.com/onmail/empty-settings-filter.png",
    "empty-settings-label.png": "https://assets.easilydo.com/onmail/empty-settings-label.png",
    "empty-settings-split-inbox.png": "https://assets.easilydo.com/onmail/empty-settings-split-inbox.png",
    "error-dog.png": "https://assets.easilydo.com/onmail/error-dog.png",
    "no-preview-available.png": "https://assets.easilydo.com/onmail/no-preview-available.png",
    "onmail.png": "https://assets.easilydo.com/onmail/onmail.png",
    "placeholder-email.png": "https://assets.easilydo.com/onmail/placeholder-email.png",
    "placeholder-file.png": "https://assets.easilydo.com/onmail/placeholder-file.png",
    "placeholder-photo.png": "https://assets.easilydo.com/onmail/placeholder-photo.png",
    "welcome-0.png": "https://assets.easilydo.com/onmail/welcome-0.png",
    "welcome-1.mp4": "https://assets.easilydo.com/onmail/videos/accept-senders.mp4",
    "welcome-2.mp4": "https://assets.easilydo.com/onmail/videos/quick-actions.mp4",
    "welcome-3.mp4": "https://assets.easilydo.com/onmail/videos/large-file-attachments.mp4",
    "welcome-4.mp4": "https://assets.easilydo.com/onmail/videos/split-inbox.mp4",
    "no-attachment-available.png": "https://assets.easilydo.com/onmail/no-attachment-available.png",
    ...
    "custom-domain-disconnected.png": "https://assets.easilydo.com/onmail/custom-domain-disconnected.png",
    "custom-domain-new-email.png": "https://assets.easilydo.com/onmail/custom-domain-new-email.png",
    "custom-domain-pending.png": "https://assets.easilydo.com/onmail/custom-domain-pending.png",
    "custom-domain-intro.png": "https://assets.easilydo.com/onmail/custom-domain-intro.png",
    "custom-domain-setting-up.png": "https://assets.easilydo.com/onmail/custom-domain-setting-up.png",
    "onBoard-logo": "https://assets.easilydo.com/onmail/logo-light.png",
    "custom-domain-bg.jpg": "https://assets.easilydo.com/onmail/custom-domain-bg.jpg",
    "custom-domain-step-1.jpg": "https://assets.easilydo.com/onmail/custom-domain-step-1.png",
    "custom-domain-step-2.jpg": "https://assets.easilydo.com/onmail/custom-domain-step-2.png",
    // Stripe
    ...
    "premium.plans.hobby.description": "A <0>{{ name }}</0> plan allows <0>{{ storage }}</0> of storage and up to <0>{{ singleFileSizeLimit }}</0> attachments for free.",
    "premium.plans.freelance.title": "Freelance Plan",
    "premium.plans.freelance.description": "A <0>{{ name }}</0> plan allows <0>{{ storage }}</0> of storage and up to <0>{{ singleFileSizeLimit }}</0> attachments for <0>{{ price }}</0> a <0>{{ priceUnit }}</0>.",
    "premium.plans.pro.title": "Professional Plan",
    "premium.plans.pro.description": "A <0>{{ name }}</0> plan <0>{{ storage }}</0> of storage and up to <0>{{ singleFileSizeLimit }}</0> attachments for <0>{{ price }}</0> a <0>{{ priceUnit }}</0> per user.",
    "premium.plans.agency.title": "Business Plan",
    "premium.plans.agency.description": "A <0>{{ name }}</0> plan allows <0>{{ storage }}</0> of storage and up to <0>{{ singleFileSizeLimit }}</0> attachments for <0>{{ price }}</0> a <0>{{ priceUnit }}</0> per user.",
    ...
    "premium.plans.pending": "Your <0>{{ name }}</0> plan will begin on <0>{{ startDate }}</0>, paid <0>{{ interval }}</0>.",
    ...
    "premium.billCalculator.notAllowed.month": "You must change your current plan to monthly before upgrading to the {{ name }} monthly plan.",
    "premium.billCalculator.notAllowed.year": "You must change your current plan to yearly before upgrading to the {{ name }} yearly plan.",
    ...
    //attachment icon img
    "archive.png": "https://assets.easilydo.com/onmail/large-attachment-icons/archive.png",
    "audio.png": "https://assets.easilydo.com/onmail/large-attachment-icons/audio.png",
    "book.png": "https://assets.easilydo.com/onmail/large-attachment-icons/book.png",
    "calendar.png": "https://assets.easilydo.com/onmail/large-attachment-icons/calendar.png",
    "code.png": "https://assets.easilydo.com/onmail/large-attachment-icons/code.png",
    "doc.png": "https://assets.easilydo.com/onmail/large-attachment-icons/doc.png",
    "font.png": "https://assets.easilydo.com/onmail/large-attachment-icons/font.png",
    "image.png": "https://assets.easilydo.com/onmail/large-attachment-icons/image.png",
    "other.png": "https://assets.easilydo.com/onmail/large-attachment-icons/other.png",
    "pdf.png": "https://assets.easilydo.com/onmail/large-attachment-icons/pdf.png",
    "presentation.png": "https://assets.easilydo.com/onmail/large-attachment-icons/presentation.png",
    "spreadsheet.png": "https://assets.easilydo.com/onmail/large-attachment-icons/spreadsheet.png",
    "video.png": "https://assets.easilydo.com/onmail/large-attachment-icons/video.png",
    "edison_logo.jpg": "https://assets.easilydo.com/onmail/icon.png",
    "onmail-loading.json": "https://assets.easilydo.com/onmail/onmail-loading.json",
    "lottie_light.min.js": "https://assets.easilydo.com/onmail/lottie_light.min.js",
    "mobileWall.signupComplete": "Sign Up Complete!",
    "mobileWall.content": "OnMail is available on mobile using Edison Mail.",
    "mobileWall.apple": "https://apps.apple.com/us/app/email-edison-mail/id922793622",
    "mobileWall.android": "https://play.google.com/store/apps/details?id=com.easilydo.mail&hl=en_US",
    ...
    // paywalls
    "paywall.customFileTransferUrl.image.src": "https://assets.easilydo.com/onmail/paywall-branded-attachments.png",
    "paywall.customFileTransferUrl.image.alt": "Custom File Transfer",
    "paywall.fileStorage.image.src": "https://assets.easilydo.com/onmail/paywall-out-of-storage.png",
    "paywall.fileStorage.image.alt": "File Storage",
    "paywall.passwordProtectedLargeFileLinks.image.src": "https://assets.easilydo.com/onmail/paywall-link-password-protection.png",
    "paywall.passwordProtectedLargeFileLinks.image.alt": "Password Protected Large File Links",
    "paywall.customDomain.image.src": "https://assets.easilydo.com/onmail/paywall-custom-domain.png",
    "paywall.customDomain.image.alt": "Custom Domains",
    "paywall.singleFileSizeLimit.image.src": "https://assets.easilydo.com/onmail/paywall-large-file-attachments.png",
    ...
    "paywall.allowSubAccounts.image.src": "https://assets.easilydo.com/onmail/paywall-subaccounts.png",
    "paywall.allowSubAccounts.image.alt": "SubAccounts",
    dictionaryPath: "https://assets.easilydo.com/onmail/dictionaries",
    pdfjsPath: "https://assets.easilydo.com/onmail/pdfjs-2.4.456-dist/web/viewer.html",
    // Data Opt In
    "dataOptIn.image": "https://assets.easilydo.com/onmail/security-share-trends.png",
    ...
    "dataOptIn.intro": "OnMail respects your right to control data as we protect your privacy. In compliance with GDPR regulations, please grant us the required permissions to process your data. You can update them at anytime.",
    ...
    "deleteAccount.before.description": "You should remove this email account from all services using this address to protect your security and privacy.",
    "deleteAccount.before.checkBox": "I acknowledge",
    "deleteAccount.confirm.title": "Are you sure?",
    "deleteAccount.confirm.description": "This action will permanently delete your account {{ email }} This should only be done if you are absolutely sure.<3/><3/>Type in <5>{{ email }}</5> to confirm.",
    ...
    // DnD
    "dnd.drop.splitInbox.title": "<0>All emails from</0><1>{{ emails }} </1> will now be found in <2>{{ name }}</2>.",
    "dnd.drop.splitInbox.subtitle": "If this message is still found in another split, you may need to make further adjustments in the <0>split inbox settings</0> to remove it.",
    "dnd.drop.splitInbox.subtitle.source_plural": "If these messages are still found in another split, you may need to make further adjustments in the <0>split inbox settings</0> to remove them.",
    "dnd.drop.splitInbox.advanced": "Need advanced options?",
    "dnd.drop.category.title": "This email and future similar ones will be found in <0>{{ name }}</0>.",
    "dnd.drop.category.title_plural": "These emails and future similar ones will be found in <0>{{ name }}</0>.",
    "dnd.drop.category.subtitle": "If this email doesn’t appear in {{ name }}, it may be under another split inbox. You may need to make further adjustments in the <1>split inbox settings</1> to remove it.",
    "dnd.drop.category.subtitle_plural": "If these emails don’t appear in {{ name }}, they may be under another split inbox. You may need to make further adjustments in the <1>split inbox settings</1> to remove them.",
    // Inbox Zero
    "inboxZero.travel.background.0": "https://images.unsplash.com/photo-1588112460947-cfb3bfeccab5?&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max",
    "inboxZero.travel.background.1": "https://images.unsplash.com/photo-1588011637159-458da884f3b2?&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max",
    "inboxZero.travel.background.2": "https://images.unsplash.com/photo-1521747116042-5a810fda9664?&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max",
    "inboxZero.shopping.background.0": "https://images.unsplash.com/photo-1520784117156-c5ce16e134b8?&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max",
    "inboxZero.shopping.background.1": "https://images.unsplash.com/photo-1561715276-a2d087060f1d?&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max",
    "inboxZero.shopping.background.2": "https://images.unsplash.com/photo-1556742208-999815fca738?&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max",
    "inboxZero.packages.background.0": "https://images.unsplash.com/photo-1579992822406-2092a7bd5a36?&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max",
    "inboxZero.packages.background.1": "https://images.unsplash.com/photo-1566576721346-d4a3b4eaeb55?&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max",
    "inboxZero.packages.background.2": "https://images.unsplash.com/photo-1466096115517-bceecbfb6fde?&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max",
    "inboxZero.events.background.0": "https://images.unsplash.com/photo-1524368535928-5b5e00ddc76b?&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max",
    "inboxZero.events.background.1": "https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max",
    "inboxZero.events.background.2": "https://images.unsplash.com/photo-1525159831892-59d292d558b4?&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max",
    "inboxZero.price_tracking.background.0": "https://images.unsplash.com/photo-1556745757-8d76bdb6984b?&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max",
    "inboxZero.price_tracking.background.1": "https://images.unsplash.com/photo-1490114538077-0a7f8cb49891?&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max",
    "inboxZero.price_tracking.background.2": "https://images.unsplash.com/photo-1522684462852-01b24e76b77d?&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max",
    "inboxZero.travel.quote": "<0></0><1></1>Your travel folder is currently empty.<1></1>Book a trip and find all your travel related receipts here. Never go searching through your inbox for your reservation numbers again.",
    "inboxZero.shopping.quote": "<0></0><1></1>Your shopping folder is empty.<1></1>Need to return those shoes you ordered last week? Easily find digital receipts in this folder.",
    "inboxZero.packages.quote": "<0></0><1></1>Your packages folder is empty.<1></1>Tracking packages has never been easier. Find all your orders in one place.",
    "inboxZero.events.quote": "<0></0><1></1>Your events folder is empty.<1></1>Time to book a reservation for dinner or tickets to a concert. When you do, find the emails here quickly with all the info you need.",
    "inboxZero.price_tracking.quote": "<0></0><1></1>No price drops are currently being tracked.<1></1>Shop like usual and get money back. OnMail will keep an eye out for any price drops in your past purchases.",
};
